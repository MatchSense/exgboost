...
static int load(ErlNifEnv *env, void **priv_data, ERL_NIF_TERM load_info) {
  ...
  DMatrix_RESOURCE_TYPE =
      enif_open_resource_type(env, NULL, "DMatrix_RESOURCE_TYPE", DMatrix_RESOURCE_TYPE_cleanup,
                              (ErlNifResourceFlags)(ERL_NIF_RT_CREATE | ERL_NIF_RT_TAKEOVER), NULL);
  Booster_RESOURCE_TYPE =
      enif_open_resource_type(env, NULL, "Booster_RESOURCE_TYPE", Booster_RESOURCE_TYPE_cleanup,
                              (ErlNifResourceFlags)(ERL_NIF_RT_CREATE | ERL_NIF_RT_TAKEOVER), NULL);
...
static int upgrade(ErlNifEnv *env, void **priv_data, void **old_priv_data, ERL_NIF_TERM load_info) {
  ...
  DMatrix_RESOURCE_TYPE = enif_open_resource_type(
      env, NULL, "DMatrix_RESOURCE_TYPE", DMatrix_RESOURCE_TYPE_cleanup, ERL_NIF_RT_TAKEOVER, NULL);
  Booster_RESOURCE_TYPE = enif_open_resource_type(
      env, NULL, "Booster_RESOURCE_TYPE", Booster_RESOURCE_TYPE_cleanup, ERL_NIF_RT_TAKEOVER, NULL);
  if (DMatrix_RESOURCE_TYPE == NULL || Booster_RESOURCE_TYPE == NULL) {
    return 1;
  }
  return 0;
...
static ErlNifFunc nif_funcs[] = {
    ...
    {"dmatrix_create_from_file", 2, EXGDMatrixCreateFromFile, ERL_NIF_DIRTY_JOB_IO_BOUND},
    {"dmatrix_create_from_uri", 1, EXGDMatrixCreateFromURI, ERL_NIF_DIRTY_JOB_IO_BOUND},
    ...
    {"booster_predict_from_dmatrix", 3, EXGBoosterPredictFromDMatrix, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_predict_from_dense", 7, EXGBoosterPredictFromDense, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_predict_from_csr", 16, EXGBoosterPredictFromCSR, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    ...
    {"booster_serialize_to_buffer", 1, EXGBoosterSerializeToBuffer, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_deserialize_from_buffer", 1, EXGBoosterDeserializeFromBuffer,
     ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_save_model_to_buffer", 2, EXGBoosterSaveModelToBuffer, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_load_model_from_buffer", 1, EXGBoosterLoadModelFromBuffer,
     ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_load_json_config", 2, EXGBoosterLoadJsonConfig, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_dump_model", 4, EXGBoosterDumpModelEx, ERL_NIF_DIRTY_JOB_CPU_BOUND},
    {"booster_save_json_config", 1, EXGBoosterSaveJsonConfig, ERL_NIF_DIRTY_JOB_CPU_BOUND}};
